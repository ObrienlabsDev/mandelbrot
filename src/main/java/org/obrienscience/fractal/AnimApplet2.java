...
public abstract class AnimApplet2 extends Applet implements MouseListener, MouseMotionListener, ActionListener {
    ...
    public static final String MAX_HEIGHT = "1024";
    public static final String MAX_WIDTH = "1024";
    ...
    public void applicationInit() {
        isApplet = false;
        izMaxHeight = 1024;//384; // try to use a power of 2
        izMaxWidth = 1024;//384;
        ...
        Frame aFrame = new Frame("Mandelbrot (c) 2013 F.Michael O'Brien");
...
/*    // allow application use outside of browser, appletviewer
    ...
    public String getAppletInfo() {
        return "(2011) Written by F.Michael O'Brien";
    }
